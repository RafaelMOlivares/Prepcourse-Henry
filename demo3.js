...
function deObjetoAarray(objeto) {
  //Hipotesis: objeto --> tesis: arreglo de arreglos
...
function numberOfCharacters(string) {
  //Hipotesis: string  --> Tesis: objeto con las letras (clave), repeticiones (valores), orden alfab
...
function sortArray(arrayOfStrings) {
  ...
  // [EJEMPLO]: ["aro", "home", "house", "looking"]  ---> ["aro", "home", "house", "looking"]
  //                              i
  //                                       j
  // Tu código:
